...
trait ManagementApi
{
    ...
    {
        return $this->model->getValuesForFieldInPolicy('p', 0);
    }
    ...
    {
        return $this->model->getValuesForFieldInPolicy('p', 1);
    }
    ...
    {
        return $this->model->getValuesForFieldInPolicy('p', 2);
    }
    ...
    {
        return $this->model->getValuesForFieldInPolicy('g', 1);
    }
